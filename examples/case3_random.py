# -*- coding: utf-8 -*-
"""
Case 3 – Random pattern: 10 drillholes with random depth (200–500 m) and
dip (70–110°) distributed across the model domain.

Outputs
-------
fig_case3_random_model_drillhole_trace.png
fig_case3_random_voi_thickness.png
"""
...
# ------------------------------------------------------------------
# Candidate drillholes – random pattern
# ------------------------------------------------------------------
n_holes = 10
x     = np.linspace(100, 1200, n_holes)
z     = np.full(n_holes, 599.5)
depth = np.random.uniform(200, 500, n_holes)
dip   = np.random.uniform(70, 110, n_holes)
...
plt.savefig(OUT_DIR / 'fig_case3_random_model_drillhole_trace.png', bbox_inches='tight')
plt.close(fig)
...
fig, (ax1, ax2) = plt.subplots(
    nrows=2, ncols=1, sharex=True, figsize=(8, 4),
...
plt.savefig(OUT_DIR / 'fig_case3_random_voi_thickness.png', bbox_inches='tight')
plt.close(fig)
